...
import BaccaratMultiHistory from '../pages/BaccaratComponents/BaccaratMultiHistory';
import BaccaratMultiHistoryID from '../pages/BaccaratComponents/BaccaratMultiHistoryID';

function BaccaratMultiHeader() {
    return ( 
...
export default BaccaratMultiHeader;